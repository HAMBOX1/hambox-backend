...
internal static class ProductEndpoints
{
    public static void MapProductEndpoints(this IEndpointRouteBuilder app, ApiVersionSet apiVersionSet)
    {
        ...
        {
            var command = new CreateProductCommand(request.NameAr, request.NameEn, request.DescriptionAr, request.DescriptionEn, request.Price, request.CategoryId, request.AdditionalCategoryIds, request.CollectionIds, request.PublicReleaseOnUtc, request.Status);
...
internal sealed record CreateProductRequest(string NameAr, string NameEn, string DescriptionAr, string DescriptionEn, decimal Price, Guid CategoryId, IReadOnlyList<Guid>? AdditionalCategoryIds = null, IReadOnlyList<Guid>? CollectionIds = null, DateTime? PublicReleaseOnUtc = null, ProductStatus? Status = null);
