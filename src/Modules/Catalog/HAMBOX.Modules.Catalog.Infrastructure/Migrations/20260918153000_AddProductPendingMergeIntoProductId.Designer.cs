...
namespace HAMBOX.Modules.Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20260918153000_AddProductPendingMergeIntoProductId")]
    partial class AddProductPendingMergeIntoProductId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HAMBOX.Modules.Catalog.Domain.Instructions.ProductInstructions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProductInstructions", "catalog");
                });
            ...
            modelBuilder.Entity("HAMBOX.Modules.Catalog.Domain.Inventory.OptionDescriptionTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OptionDescriptionTemplates", "catalog");
                });

            modelBuilder.Entity("HAMBOX.Modules.Catalog.Domain.Inventory.OptionGroupTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OptionGroupTemplates", "catalog");
                });

            modelBuilder.Entity("HAMBOX.Modules.Catalog.Domain.Inventory.OptionGroupTemplateOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TemplateId", "Value")
                        .IsUnique();

                    b.ToTable("OptionGroupTemplateOptions", "catalog");
                });
            ...
            modelBuilder.Entity("HAMBOX.Modules.Catalog.Domain.Inventory.ProductVariant", b =>
                {
                    ...
                    b.Property<int?>("ManualDeliveryCapacity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HAMBOX.Modules.Catalog.Domain.Products.Product", b =>
                {
                    ...
                    b.Property<Guid?>("PendingMergeIntoProductId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("Price")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateTime?>("PublicReleaseOnUtc")
                    ...
                    b.HasIndex("PendingMergeIntoProductId")
            ...
            modelBuilder.Entity("HAMBOX.Modules.Catalog.Domain.Inventory.OptionGroupTemplateOption", b =>
                {
                    b.HasOne("HAMBOX.Modules.Catalog.Domain.Inventory.OptionGroupTemplate", null)
                        .WithMany("Options")
            ...
            modelBuilder.Entity("HAMBOX.Modules.Catalog.Domain.Products.Product", b =>
                {
                    ...
                    b.HasOne("HAMBOX.Modules.Catalog.Domain.Products.Product", null)
                        .WithMany()
                        .HasForeignKey("PendingMergeIntoProductId")
