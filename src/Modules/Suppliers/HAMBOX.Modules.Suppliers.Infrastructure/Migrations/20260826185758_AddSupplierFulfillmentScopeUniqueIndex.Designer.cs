...
namespace HAMBOX.Modules.Suppliers.Infrastructure.Migrations
{
    ...
    [Migration("20260826185758_AddSupplierFulfillmentScopeUniqueIndex")]
    partial class AddSupplierFulfillmentScopeUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HAMBOX.Modules.Suppliers.Domain.Fulfillments.SupplierFulfillment", b =>
                {
                    ...
                    b.HasIndex("OrderId", "OrderItemId", "SupplierId", "SupplierProductMappingId")
                        ...
                        .HasFilter("Status NOT IN ('Succeeded', 'PartialFailed', 'Failed')");
