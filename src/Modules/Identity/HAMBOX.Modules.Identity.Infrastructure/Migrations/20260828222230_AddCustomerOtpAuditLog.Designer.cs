...
namespace HAMBOX.Modules.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260828222230_AddCustomerOtpAuditLog")]
    partial class AddCustomerOtpAuditLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HAMBOX.Modules.Identity.Domain.Audit.CustomerOtpAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OccurredOnUtc")
                        .HasDatabaseName("IX_CustomerOtpAuditLogs_OccurredOnUtc");

                    b.HasIndex("Purpose")
                        .HasDatabaseName("IX_CustomerOtpAuditLogs_Purpose");

                    b.HasIndex("TokenId")
                        .HasDatabaseName("IX_CustomerOtpAuditLogs_TokenId");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_CustomerOtpAuditLogs_UserId");

                    b.ToTable("CustomerOtpAuditLogs", "identity");
                });
            ...
            modelBuilder.Entity("HAMBOX.Modules.Identity.Domain.Permissions.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            GroupId = new Guid("15000000-0000-0000-0000-000000000034"),
                            Name = "Faq.View",
                            NormalizedName = "FAQ.VIEW",
                            SortOrder = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("HAMBOX.Modules.Identity.Domain.Permissions.PermissionGroup", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("15000000-0000-0000-0000-000000000034"),
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Global, product, and category scoped frequently-asked-question entries",
                            Key = "Faq",
                            Module = "Platform",
                            Name = "FAQ",
                            SortOrder = 150
            ...
            modelBuilder.Entity("HAMBOX.Modules.Identity.Domain.Roles.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PermissionId = new Guid("20000000-0000-0000-0000-000000000276"),
                            RoleId = new Guid("10000000-0000-0000-0000-000000000002")
                        },
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PermissionId = new Guid("20000000-0000-0000-0000-000000000277"),
                            RoleId = new Guid("10000000-0000-0000-0000-000000000002")
                        },
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PermissionId = new Guid("20000000-0000-0000-0000-000000000278"),
                            RoleId = new Guid("10000000-0000-0000-0000-000000000002")
                        },
                        new
                        {
                            ...
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PermissionId = new Guid("20000000-0000-0000-0000-000000000279"),
                            RoleId = new Guid("10000000-0000-0000-0000-000000000002")
                        },
                        new
                        {
