...
public static class MembershipDataSeeder
{
    public static async Task SeedAsync(IServiceProvider services, CancellationToken cancellationToken = default)
    {
        ...
        free.AddBenefit(MembershipBenefitType.Badge, "free", "Free Badge", 2);
        free.Activate();

        var silver = CreatePlan("Silver", "silver", "Enhanced savings and support.", 9.99m, 30, 1, "Silver", "silver");
        ...
        var gold = CreatePlan("Gold", "gold", "Popular plan with meaningful perks.", 19.99m, 30, 2, "Gold", "gold");
        ...
        gold.AddBenefit(MembershipBenefitType.EarlyAccess, "true", "Early Access Drops", 3);
        gold.AddBenefit(MembershipBenefitType.PrioritySupport, "true", "Priority Support", 4);
        gold.Activate();

        var platinum = CreatePlan("Platinum", "platinum", "Premium marketplace access.", 39.99m, 30, 3, "Platinum", "platinum");
        ...
        platinum.AddBenefit(MembershipBenefitType.EarlyAccess, "true", "Early Access Drops", 4);
        platinum.Activate();

        var vip = CreatePlan("VIP", "vip", "Maximum benefits for top members.", 79.99m, 30, 4, "VIP", "vip");
        ...
        vip.AddBenefit(MembershipBenefitType.EarlyAccess, "true", "Early Access Drops", 4);
        vip.AddBenefit(MembershipBenefitType.ThemeUnlock, "vip", "VIP Theme Unlock", 5);
        vip.Activate();
